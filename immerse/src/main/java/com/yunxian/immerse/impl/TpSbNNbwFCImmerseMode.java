 ...
 */
@TargetApi(LOLLIPOP)
public class TpSbNNbwFCImmerseMode extends AbsImmerseMode {
    ...
    public TpSbNNbwFCImmerseMode(@NonNull Activity activity, @NonNull ImmerseConfiguration immerseConfiguration) {
